...
GreasyFork Premium does not collect, transmit, sell, or share any personal data.
...
GreasyFork Premium may load trusted third-party resources required for specific features.

Currently, Highlight.js is used for syntax highlighting.

## Open Source

The entire source code is publicly available on GitHub and can be reviewed by anyone.
